...
def download_posts_from_the_page() -> None:
    try:
        ...
        time.sleep(3)
        # Получаем дату публикации поста (дата публикации)
        ...
        video_src = ('/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[1]/div[2]/section/main/div/div[1]/div/div[1]/'
                     'div/div/div/div/div/div/div/div/div/div/div/video')
        img_src = ("/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[1]/div[2]/section/main/div/div[1]/div/div[1]/"
                   "div/div/div/div/div/div/div[1]/div[1]")
...
def main() -> None:
    ...
    if user_input == "1":
        ...
        download_posts_from_the_page()  # Скачать посты со страницы в папку "downloaded_content" с названием поста
